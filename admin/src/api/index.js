...
export const createService = (newService) =>
  API.post("/profile/services", newService);
export const updateService = (id, updatedService) =>
  API.patch(`/profile/services/${id}`, updatedService);
...
export const deleteCategorie = (id) =>
  API.delete(`/CategorieList/delete/${id}`);
export const fetchCategories = () => API.get("/CategorieList");
export const createCategory = (newCategory) =>
  API.post("/CategorieList/post", newCategory);
export const updateCategory = (id, updatedService) =>
  API.patch(`/CategorieList/update/${id}`, updatedService);
//requests
