...
function ArtisanForm({formData,showPassword,handleShowPassword,handlechange,governorate,isUpdate}) {
    ...
    return (
        ...
        <div style={{display:'flex',flexDirection:'row',paddingTop:'25px'}}>    
            <div className="col-md-6 form-group p_star" style={{paddingBottom:'25px'}}>
                <input type="text" className="form-control" name="name" id="name"  value={formData.name} required placeholder="Full name" title="Your Name ..."  onChange={handlechange}  />
            </div>
            <div className="col-md-6 form-group p_star" style={{paddingBottom:'25px'}}>
        ...
        <div className="col-md-12 form-group p_star">
            <InputLabel >Your shop address (or address of residence) : </InputLabel>
        </div> 
